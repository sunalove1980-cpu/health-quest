...
export const INITIAL_STATE = { schemaVersion:3, settings:{theme:'dark'}, habits:DEFAULT_HABITS, records:{}, player:{totalXp:0,coins:0,bonusXp:0,bonusCoins:0,spentCoins:0,badges:[],inventory:[],equipped:{},companionName:'',chatMessages:[],createdAt:new Date().toISOString()}, transactions:[], weekly:{}, dailyEvents:{} };
